...
class ManualEntry extends StatefulWidget {
  final String type;
  const ManualEntry({Key? key, required this.type}) : super(key: key);

  @override
  _AddGroceryItemsState createState() => _AddGroceryItemsState();
}

class _AddGroceryItemsState extends State<ManualEntry> {
  ...
  void _addListProductFunction() async {
    await Provider.of<GroceryList>(context, listen: false)
        ...
        title: RichText(
          text: TextSpan(
            ...
            children: <TextSpan>[
              TextSpan(
                text: (() {
                  if (widget.type == "Fridge") return "Fridge";
                  if (widget.type == "Pantry") return "Pantry";
                  if (widget.type == "Other") return "Freezer";
                  return "";
                }()),
                style: TextStyle(
                    fontSize: 16,
